-- Phase 5.9.3.2: vendors.general_email (company-level email).
--
-- Follow-on from the 5.9.3 smoke: vendors carry a single primary contact
-- (contact_name/email/phone). Jimmie wants a company-level general email
-- distinct from any contact. (Main phone was considered but dropped; only the
-- general email lands.)
--
-- 1. Add the nullable column.
-- 2. CREATE OR REPLACE bulk_import_commit_vendors to write general_email on
